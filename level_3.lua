...
local function nextLevel(event)
    resetScoreboard(0)
    scoreText.text = " "
    composer.gotoScene("level_complete") -- going to level complete
end
...
--      output: none
--
--      This function starts the 3000ms timer for level 1 and begins the animations for both alex and
--      janken. 
local function play()
    decisionTimer = timer.performWithDelay( 3000, checkHands, 1 )
